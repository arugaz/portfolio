use crate::{
  component::animate::{DivContent, SectionContent, SpanFade},
  data::techstuff::TECH_STUFF,
};
...
pub fn about_page() -> Html {
  html! {
    <main class="relative flex w-full flex-col items-center justify-evenly py-40 md:h-screen md:flex-row md:overflow-hidden">
      ...
      <DivContent class="relative order-2 flex w-3/4 flex-col items-end justify-end md:order-1 md:w-1/3">
      ...
      <SectionContent class="relative order-1 my-10 w-3/4 md:order-2 md:my-0 md:w-1/4">
