...
export default function Home() {
  return (
    <main className="relative flex w-full flex-col items-center justify-evenly py-40 md:h-screen md:flex-row md:overflow-hidden">
      ...
      >
        <h3 className="-ml-1 text-5xl font-bold text-primary-light">
          Welcome To
        </h3>
        <h3 className="-ml-1 text-3xl font-bold text-primary-light">
          SkyUniverse Website
        </h3>
        <h4 className="text-base font-light transition-all duration-500 hover:text-primary-light">
          The place where you can get anything that you need.
        </h4>
      </motion.section>
    </main>
  );
